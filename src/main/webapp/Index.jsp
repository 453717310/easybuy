...
<div class="soubg">
	<div class="sou">
        ...
        <!--End 所在收货地区 End-->
        <span class="fr">
        	<span class="fl">你好，请<a href="user/login.html">登录</a>&nbsp; <a href="user/regist" style="color:#ff4e00;">免费注册</a>&nbsp;|&nbsp;<a href="#">我的订单</a>&nbsp;|</span>
        	<span class="ss">
            	<div class="ss_list">
                	<a href="#">收藏夹</a>
...
<div class="top">
    ...
    <div class="i_car">
        ...
        <div class="car_bg">
       		<!--Begin 购物车未登录 Begin-->
        	<div class="un_login">还未登录！<a href="WEB-INF/jsp/user/login.jsp" style="color:#ff4e00;">马上登录</a> 查看购物车！</div>
            <!--End 购物车未登录 End-->
            <!--Begin 购物车已登录 Begin-->
            <ul class="cars">
            	<li>
        ...
        <div class="hot_pro">        	
        	<div id="featureContainer">
                <div id="feature">
                    ...
                    <a class="h_prev" href="javascript:void(1);">Previous</a>
                    <a class="h_next" href="javascript:void(1);">Next</a>
                </div>
            </div>
        </div>
    </div>
